...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-143698664-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-143698664-1', { 'optimize_id': 'GTM-WMV2MT2'});
</script>

	<meta charset='<?php bloginfo( 'charset' ); ?>'>
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<meta name="title" content="Resort FarmVilla - Best Family Resort To Spend Quality time">
    <meta name="keywords" content="resort in bhuj, resort in kutch, resort in kuchchh, weekend resort, hotels in bhuj, hotels in kutch, oyo resort, resort farmvilla, farmvilla, bhujodi, places in bhuj">
