...
if (seopress_breadcrumbs_enable_option() =='1' || seopress_breadcrumbs_json_enable_option() =='1') {
	function seopress_display_breadcrumbs($echo = true) {
		...
		if ((is_front_page() && is_paged() ) || !is_front_page()) {
			...
			$sp_breadcrumbs .= '<nav aria-label="breadcrumb"><ol class="breadcrumb" itemscope itemtype="'.seopress_check_ssl().'schema.org/BreadcrumbList">'.$sp_breadcrumbs_html.'</ol></nav>';
			...
			if (seopress_breadcrumbs_json_enable_option() =='1') {
				...
				echo json_encode($sp_breadcrumbs_json);
				echo '</script>';
			}
			...
			if (seopress_breadcrumbs_enable_option() =='1') {
				if ($echo === true) {
					...
					return $sp_breadcrumbs.do_action('seopress_breadcrumbs_after_html');
				}
			}
		}
	}
	function seopress_shortcode_breadcrumbs(){
		return seopress_display_breadcrumbs(0);
	}
	if (seopress_breadcrumbs_enable_option() =='1') {
