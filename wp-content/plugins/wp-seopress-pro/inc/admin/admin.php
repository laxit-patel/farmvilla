...
class seopress_pro_options
{
    ...
    public function page_init()
    {
        ...
        // //Google Analytics E-commerce SECTION======================================================
        // add_settings_section(
        //     'seopress_setting_section_google_analytics_e_commerce', // ID
        //     '',
        //     //__("Google Analytics E-commerce","wp-seopress"), // Title
        //     array( $this, 'print_section_info_google_analytics_e_commerce' ), // Callback
        //     'seopress-settings-admin-google-analytics-e-commerce' // Page
        // );
        // add_settings_field(
        //     'seopress_google_analytics_e_commerce_enable', // ID
        //    __("Enable Google Analytics E-commerce tracking","wp-seopress-pro"), // Title
        //     array( $this, 'seopress_google_analytics_e_commerce_enable_callback' ), // Callback
        //     'seopress-settings-admin-google-analytics-e-commerce', // Page
        //     'seopress_setting_section_google_analytics_e_commerce' // Section                  
        // );
    ...
    {   
        ...
        foreach ($seopress_pro_sanitize_fields as $value) {
    ...
    {
        echo '<p>'.__('The bot scans links in your content to find errors (404...). We limit this search to the last 100 posts/pages/custom post types.', 'wp-seopress-pro');
        echo '<br>';
    ...
    {
        print __('<p>Add Structured Data Types support, mark your content and get better Google Search Results appearance</p>', 'wp-seopress-pro');
    ...
    public function print_section_info_news()
    {
        ...
        echo '<br>';
        echo '<br>';
        echo '<a href="'.home_url().'/sitemaps.xml" target="_blank" class="button"><span class="dashicons dashicons-visibility"></span>'.__('View your sitemap','wp-seopress-pro').'</a>';
        echo '&nbsp;';
        echo '<a href="https://www.google.com/ping?sitemap='.home_url().'/sitemaps/" target="_blank" class="button"><span class="dashicons dashicons-share-alt2"></span>'.__('Ping Google manually','wp-seopress-pro').'</a>';        
        echo '&nbsp;';
    ...
    public function print_section_info_google_analytics_dashboard()
    {
        ...
        echo '<span class="dashicons dashicons-external"></span><a href="'.$seopress_docs_link['support']['google_analytics']['dashboard'].'" target="_blank">'. __('Watch our video guide to connect your WordPress site with Google Analytics API.','wp-seopress-pro').'</a></p>';
    }
    ...
    public function seopress_bot_scan_settings_post_types_callback() 
    {
        ...
        $check = isset($options['seopress_bot_scan_settings_post_types']);      
    ...
    public function seopress_bot_scan_settings_number_callback()
    {
        ...
        echo '<input type="number" min="0" name="seopress_bot_option_name[seopress_bot_scan_settings_number]"';
        ...
        echo '<p>'.__('The higher the value, the more time it will take.','wp-seopress-pro').'</p>';
    }
    ...
    public function seopress_woocommerce_product_og_price_callback()
    {
        ...
        echo '<label for="seopress_woocommerce_product_og_price">'. __( 'Add OG:PRICE meta for product', 'wp-seopress-pro' ) .'</label>';
    ...
    public function seopress_woocommerce_product_og_currency_callback()
    {
        ...
        echo '<label for="seopress_woocommerce_product_og_currency">'. __( 'Add OG:CURRENCY meta for product', 'wp-seopress-pro' ) .'</label>';
    ...
    public function seopress_edd_product_og_price_callback()
    {
        ...
        echo '<label for="seopress_edd_product_og_price">'. __( 'Add OG:PRICE meta for product', 'wp-seopress-pro' ) .'</label>';
    ...
    public function seopress_edd_product_og_currency_callback()
    {
        ...
        echo '<label for="seopress_edd_product_og_currency">'. __( 'Add OG:CURRENCY meta for product', 'wp-seopress-pro' ) .'</label>';
    ...
    public function seopress_breadcrumbs_enable_callback()
    {
        ...
        echo '<label for="seopress_breadcrumbs_enable">'. __( 'Enable Breadcrumbs', 'wp-seopress-pro' ) .'</label>';
...
User-agent: SemrushBot-SA
    ...
    // public function seopress_google_analytics_e_commerce_enable_callback()
    // {
    //     $options = get_option( 'seopress_google_analytics_option_name' );  
        
    //     $check = isset($options['seopress_google_analytics_e_commerce_enable']);      
        
    //     echo '<input id="seopress_google_analytics_e_commerce_enable" name="seopress_google_analytics_option_name[seopress_google_analytics_e_commerce_enable]" type="checkbox"';
    //     if ('1' == $check) echo 'checked="yes"'; 
    //     echo ' value="1"/>';
        
    //     echo '<label for="seopress_google_analytics_e_commerce_enable">'. __( 'Enable E-commerce tracking', 'wp-seopress-pro' ) .'</label><br><br>';

    //     if (isset($this->options['seopress_google_analytics_e_commerce_enable'])) {
    //         esc_attr( $this->options['seopress_google_analytics_e_commerce_enable']);
    //     }
    // }
