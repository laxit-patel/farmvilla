    ...
    if ( is_admin() ) {
        ...
        function seopress_404_btn_cpt() {
            ?>
                ...
                jQuery(function(){
                    jQuery("body.post-type-seopress_404 .wrap h1 ~ #seopress-cat-redirects").after('<a href="<?php echo admin_url( 'admin.php?page=seopress-import-export#section-import-redirects' ); ?>" id="seopress-import-redirects" style="margin: 10px 0 0 10px;" class="button"><?php _e('Import your redirects','wp-seopress-pro'); ?></a>');
                });
                jQuery(function(){
                    jQuery("body.post-type-seopress_404 .wrap h1 ~ #seopress-import-redirects").after('<a href="<?php echo admin_url( 'admin.php?page=seopress-import-export#section-export-redirects' ); ?>" id="seopress-export-redirections" style="margin: 10px 0 0 10px;" class="button"><?php _e('Export your redirects','wp-seopress-pro'); ?></a>');
                });
                </script>
            <?php
        }
        ...
        function seopress_404_filters_action($query) {
            ...
            if ( is_admin() && 'seopress_404' == $current_page && 'edit.php' == $pagenow && (isset( $_GET['redirection-cat'] ) && 
                $_GET['redirection-cat'] !='' )) {
                $redirection_cat = $_GET['redirection-cat'];
            ...
            if ( is_admin() && 'seopress_404' == $current_page && 'edit.php' == $pagenow && (isset( $_GET['redirection-cat'] ) && 
                $_GET['redirection-cat'] !='' && isset( $_GET['redirection-type'] ) && 
                ...
                if (get_post_status($seopress_get_page->ID) =='publish') {
                    if (get_post_meta($seopress_get_page->ID,'_seopress_redirections_enabled',true)) {
                        ...
                        elseif (get_post_meta($seopress_get_page->ID,'_seopress_redirections_value',true)) {
                            //URL redirection
                            $seopress_redirections_value = get_post_meta($seopress_get_page->ID,'_seopress_redirections_value',true);
