...
DROP TABLE IF EXISTS `fm_gf_form_meta`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `fm_gf_form_meta` (
...
LOCK TABLES `fm_gf_form_meta` WRITE;
/*!40000 ALTER TABLE `fm_gf_form_meta` DISABLE KEYS */;
/*!40000 ALTER TABLE `fm_gf_form_meta` ENABLE KEYS */;
UNLOCK TABLES;
