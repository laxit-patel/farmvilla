...
DROP TABLE IF EXISTS `fm_hb_booking_rules`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `fm_hb_booking_rules` (
...
LOCK TABLES `fm_hb_booking_rules` WRITE;
/*!40000 ALTER TABLE `fm_hb_booking_rules` DISABLE KEYS */;
/*!40000 ALTER TABLE `fm_hb_booking_rules` ENABLE KEYS */;
UNLOCK TABLES;
