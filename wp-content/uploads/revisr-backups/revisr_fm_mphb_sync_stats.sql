...
DROP TABLE IF EXISTS `fm_mphb_sync_stats`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `fm_mphb_sync_stats` (
...
LOCK TABLES `fm_mphb_sync_stats` WRITE;
/*!40000 ALTER TABLE `fm_mphb_sync_stats` DISABLE KEYS */;
/*!40000 ALTER TABLE `fm_mphb_sync_stats` ENABLE KEYS */;
UNLOCK TABLES;
