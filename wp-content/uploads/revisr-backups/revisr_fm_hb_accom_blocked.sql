...
DROP TABLE IF EXISTS `fm_hb_accom_blocked`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `fm_hb_accom_blocked` (
...
LOCK TABLES `fm_hb_accom_blocked` WRITE;
/*!40000 ALTER TABLE `fm_hb_accom_blocked` DISABLE KEYS */;
/*!40000 ALTER TABLE `fm_hb_accom_blocked` ENABLE KEYS */;
UNLOCK TABLES;
