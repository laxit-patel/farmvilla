...
DROP TABLE IF EXISTS `fm_hb_ical`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `fm_hb_ical` (
...
LOCK TABLES `fm_hb_ical` WRITE;
/*!40000 ALTER TABLE `fm_hb_ical` DISABLE KEYS */;
/*!40000 ALTER TABLE `fm_hb_ical` ENABLE KEYS */;
UNLOCK TABLES;
