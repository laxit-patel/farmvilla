...
DROP TABLE IF EXISTS `fm_hb_options`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `fm_hb_options` (
...
LOCK TABLES `fm_hb_options` WRITE;
/*!40000 ALTER TABLE `fm_hb_options` DISABLE KEYS */;
/*!40000 ALTER TABLE `fm_hb_options` ENABLE KEYS */;
UNLOCK TABLES;
